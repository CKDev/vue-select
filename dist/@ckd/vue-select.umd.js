...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_select_vue_vue_type_style_index_0_id_050c8355_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("4097");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_select_vue_vue_type_style_index_0_id_050c8355_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_select_vue_vue_type_style_index_0_id_050c8355_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_select_vue_vue_type_style_index_0_id_050c8355_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// module
exports.push([module.i, ".v-select[data-v-050c8355]{display:inline-block;min-width:10px;-webkit-box-sizing:border-box;box-sizing:border-box;text-align:left;position:relative;background:#fff;outline:none}.v-select.is-disabled .label[data-v-050c8355]{cursor:default}.v-select.is-open .options[data-v-050c8355]{z-index:1;-webkit-animation:show-data-v-050c8355 .15s ease-out;animation:show-data-v-050c8355 .15s ease-out;-webkit-animation-fill-mode:forwards;animation-fill-mode:forwards}.v-select.is-seeking .v-option[data-v-050c8355]{pointer-events:none}.v-select.is-mobile .select[data-v-050c8355]{opacity:0;display:block;width:100%;height:100%;position:absolute;left:0;top:0}.v-select.is-focused .label[data-v-050c8355]{outline-width:2px;outline-style:solid;outline-color:Highlight}@media (-webkit-min-device-pixel-ratio:0){.v-select.is-focused .label[data-v-050c8355]{outline-color:-webkit-focus-ring-color;outline-style:auto}}.v-select *[data-v-050c8355]{-webkit-box-sizing:border-box;box-sizing:border-box}.label[data-v-050c8355]{display:block;border:1px solid #e5e5e5;padding:6px 10px;width:var(--width);max-width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;cursor:pointer;font-weight:400;font-size:16px;line-height:1.4}.label[data-v-050c8355]:empty:after{content:\".\";visibility:hidden}.options[data-v-050c8355]{overflow:auto;z-index:0;border:1px solid #e5e5e5;max-height:var(--height);background:inherit;position:fixed;top:var(--top);left:var(--left);width:var(--width);-webkit-animation:hide-data-v-050c8355 .15s ease-out;animation:hide-data-v-050c8355 .15s ease-out;-webkit-animation-fill-mode:forwards;animation-fill-mode:forwards}.select[data-v-050c8355]{cursor:pointer;display:none}@-webkit-keyframes hide-data-v-050c8355{0%{display:block;opacity:1}99%{display:block;-webkit-transform:scale(1);transform:scale(1)}to{display:none;-webkit-transform:scale(0);transform:scale(0);opacity:0}}@keyframes hide-data-v-050c8355{0%{display:block;opacity:1}99%{display:block;-webkit-transform:scale(1);transform:scale(1)}to{display:none;-webkit-transform:scale(0);transform:scale(0);opacity:0}}@-webkit-keyframes show-data-v-050c8355{0%{display:none;opacity:0}1%{display:block;opacity:0}to{display:block;opacity:1}}@keyframes show-data-v-050c8355{0%{display:none;opacity:0}1%{display:block;opacity:0}to{display:block;opacity:1}}", ""]);
...
var update = add("1b2ec6aa", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./src/select.vue?vue&type=template&id=050c8355&scoped=true&
  ...
  methods: {
    ...
    onArrowPress: function onArrowPress(offset) {
      ...
      if (this.highlightIndex < 0) {
        ...
        if (offset < 0) {
          // Moving up the list
          var candidates = this.list.slice(0, this.highlightIndex).filter(function (o) {
          ...
          var _candidates = this.list.slice(this.highlightIndex + 1, this.list.length - 1).filter(function (o) {
            return !o.state.group && !o.disabled;
          }); // If any options to move to, move to the closest (first) one in the list


          if (_candidates.length) this.highlightIndex = _candidates.shift().state.index;
        }
...
// EXTERNAL MODULE: ./src/select.vue?vue&type=style&index=0&id=050c8355&lang=scss&scoped=true&
var selectvue_type_style_index_0_id_050c8355_lang_scss_scoped_true_ = __webpack_require__("0e27");
